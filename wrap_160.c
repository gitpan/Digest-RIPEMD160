...
void RIPEMD160_init(Digest__RIPEMD160 ripemd160)
#else
...
#ifdef USE_RMD160CRYPT_HEADER
void RIPEMD160_update(Digest__RIPEMD160 ripemd160, byte *strptr, dword len)
#else
...
#ifdef USE_RMD160CRYPT_HEADER
void RIPEMD160_final(Digest__RIPEMD160 ripemd160)
#else
...
#ifdef USE_RMD160CRYPT_HEADER
void RIPEMD160_HMAC(Digest__RIPEMD160 ripemd160,
