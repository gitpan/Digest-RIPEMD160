...
MODULE = Digest::RIPEMD160	PACKAGE = Digest::RIPEMD160	PREFIX = rmd160_

PROTOTYPES: DISABLE

Digest::RIPEMD160
rmd160_new(packname = "Digest::RIPEMD160")
	char *		packname
    CODE:
	{
	    RETVAL = (Digest__RIPEMD160) safemalloc(sizeof(RIPEMD160_INFO));
