...
bootstrap Digest::RIPEMD160 $VERSION;
...
Digest::RIPEMD160 - Perl extension for the RIPEMD-160 Hash function

=head1 SYNOPSIS

    use Digest::RIPEMD160;
    
    $context = new Digest::RIPEMD160;
    $context->reset();
    ...
    $digest = Digest::RIPEMD160->hash(SCALAR);
    $string = Digest::RIPEMD160->hexhash(SCALAR);
